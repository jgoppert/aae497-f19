...
static int casadi_f2(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem) {
  ...
  a3=(a5?a0:0);
  a5=(!a5);
  a6=4.5999999999999996e+00;
  a6=(a6<a2);
  a7=2.0000000000000001e-01;
  a8=(a6?a7:0);
  a6=(!a6);
  a9=4.5000000000000000e+00;
  a9=(a9<a2);
  a10=(a9?a0:0);
  a9=(!a9);
  a11=4.4000000000000004e+00;
  a11=(a11<a2);
  a11=(!a11);
  a12=4.2999999999999998e+00;
  a12=(a12<a2);
  a13=(a12?a4:0);
  a12=(!a12);
  a14=4.2000000000000002e+00;
  a14=(a14<a2);
